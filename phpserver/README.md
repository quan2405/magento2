...
```
php bin/magento setup:install --base-url=http://127.0.0.1:8080 
...
Notes:
- By default, Magento creates a random Admin URI for you. Make sure to write this value down because it's how you access the Magento Admin later. For example : ```http://127.0.0.1:8080/index.php/admin_1vpn01```.
...
Example usage: ```php -S 127.0.0.1:8080 -t ./pub/ ./phpserver/router.php```
